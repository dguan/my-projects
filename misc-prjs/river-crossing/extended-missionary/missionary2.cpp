...
template<class BiItor> bool next_combination_idx(int n, BiItor comb_first, BiItor comb_last)
{
...
std::vector<std::tuple<int, std::string>> find_solution_dfs(const state& cur_st, int boat_volume, UsedStateTable& used_states)
{
