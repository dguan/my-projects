...
(please refer to WIKI: http://en.wikipedia.org/wiki/Missionaries_and_cannibals_problem)

I solved the above classic missionary-cannibal problem with an improvement to deal with arbitrary number of missionaries and cannibals.

Also, I extended the classic problem, suppose that each missionary and cannibal took different different time to row the boat across the river, try to find out optimal solution that takes least time. 
